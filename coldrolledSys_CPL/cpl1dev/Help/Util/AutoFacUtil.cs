...
namespace Core.Util
{
    public static class AutoFacUtil
    {
        ...
        public static void RegisterSelfSingleton<Type>(this IRegistrationBuilder<Type, SimpleActivatorData, SingleRegistrationStyle> builder)
        {
        ...
        public static void RegisterFrame<IPresneter, Presneter, IView, View>(this ContainerBuilder builder)
        {
            builder.RegisterType<Presneter>()
               ...
               .AsSelf()
               .SingleInstance();
            // 因為View Present要互用 不能都使用Properties註冊. 會有循環相依問題
