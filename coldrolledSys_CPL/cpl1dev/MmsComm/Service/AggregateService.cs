...
namespace MMSComm.Service
{
    public class AggregateService
    {
        ...
        public MMS_Heartbeat_Structure GetNowHeartBeatMsg()
        {
            ...
            MMSHeartBeatMsg.Header.Date = dateTime.ToString("yyyyMMdd").ToCByteArray(8);
            MMSHeartBeatMsg.Header.Time = dateTime.ToString("HHmmss").ToCByteArray(6);
