...
namespace LabelPrint.Printer
{
    public static class ZebraCmd
    {
        ...
        public static string zplQRCmd(this string coilID, string stNo, string thick, string sampleNo, string sampleCode)
        {
            //var stNo = data.StNo;
            var equip = "CPL";
            //var thick = data.Thick;
            var datetime = DateTime.Now; //data.PrintDateTime ?? DateTime.Now;
            //var sampleNo = data.SampleNo;
            var coilNo = coilID;// data.CoilNo;
            ...
            return $@"^XA
                   ...
                   ^FO220,135
                   ^CFA,40,20
                   ^FD{datetime:yyyy/MM/dd  HH:mm}^FS
