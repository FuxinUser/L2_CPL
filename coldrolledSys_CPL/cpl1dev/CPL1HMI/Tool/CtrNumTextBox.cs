...
namespace Common.StTool
{
    public partial class CtrNumTextBox : TextBox
    {
        ...
        protected override void OnValidating(CancelEventArgs e)
        {
            ...
            //    if (dcTol > dcIdg)
            //    {
            //        //DialogHandler.Instance.Fun_DialogShowOk("整数限" + dcReIdg + "位，\r\n小数限" + intDecimalDigit + "位！", "栏位输入提示", 0);  
            //        //this.Focus();
            //        //return;
            //    }
            ...
            //    if ((dcTol % 1) != 0)
            //    {
            //        //DialogHandler.Instance.Fun_DialogShowOk("小数位数限" + intDecimalDigit + "位！", "栏位输入提示", 0);
            //        //this.Focus();
            //        //return;
            //    }
            //}
            ...
            //    {
            //        //DialogHandler.Instance.Fun_DialogShowOk("该字段无小数位数！", "栏位输入提示", 0);
            //        //this.Focus();
            //        //return;
            //    }
            //}
        ...
        public int IntegerDigit
        {
            ...
            set
            {
                ...
                if (intIntegerDigit > 20 || intIntegerDigit < 0)
                    intIntegerDigit = 20;
