...
namespace CPL1HMI
{
    public class TestPrinter : ReceiveActor
    {
        ...
        public TestPrinter(ISysAkkaManager akkaManager, LprContract.IPresenter presenter, Zebra zebraClient, ILog log) : base(log)
        {
            Presenter = presenter;
