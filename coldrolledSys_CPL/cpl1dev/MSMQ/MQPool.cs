...
namespace MSMQ
{
    public static class MQPool
    {
        ...
        private static ConcurrentDictionary<string, MQHelper> _container = new ConcurrentDictionary<string, MQHelper>();
        ...
        public class MQHelper
        {
            ...
            {
                //Create(_mqPath);
                MQMessage box = new MQMessage() { ID = messageID, Data = message };
                lock (_safelock)
                {            
                    try
                    {
