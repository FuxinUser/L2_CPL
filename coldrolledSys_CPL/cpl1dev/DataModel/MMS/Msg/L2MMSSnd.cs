...
namespace MsgStruct
{
    public class L2MMSSnd
    {
        ...
        public class Msg_PDO
        {
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)]
            public byte[] Out_Head_Paper_Length = new byte[5];
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)]
            public byte[] Out_Head_Paper_Width = new byte[5];
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)]
            public byte[] Out_Tail_Paper_Length = new byte[5];
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)]
            public byte[] Out_Tail_Paper_Width = new byte[5];
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
            public byte[] Sleeve_Inner_Exit_Diamter = new byte[4];
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
            public byte[] Sleeve_Type_Exit_Code = new byte[3];
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 7)]
            public byte[] Tail_PunchHole_Position = new byte[7];
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)]
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
            public byte[] Scraped_Length_Entry = new byte[4];
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
            public byte[] Scraped_Length_Exit = new byte[4];
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)]
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 1)]
            public byte[] Winding_Direction = new byte[1];
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 1)]
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 1)]
            public byte[] No_Leader_Code = new byte[1];
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
            public byte[] Surface_Accuracy_Code = new byte[2];
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)]
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 1)]
            public byte[] Flip_Tag = new byte[1];
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 6)]
            public byte[] Process_Code = new byte[6];
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 1)]
            public byte[] Decoiler_Direction = new byte[1];
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 7)]
            public byte[] Recoiler_Actten_Avg = new byte[7];

            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
            public byte[] Side_Trimmer_Gap = new byte[3];
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
            public byte[] Side_Trimmer_Lap = new byte[4];
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)]
            public byte[] Side_Trimmer_Width = new byte[5];
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
            public byte[] Trimming_OperateSide = new byte[3];
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
            public byte[] Trimming_DriveSide = new byte[3];
        ...
        public class Msg_Dummy_Coil_Result_Del
        {
            ...
            public byte[] Dummy_Coil_No;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 5)]
            public byte[] ReasonOfDelete;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 14)]
            public byte[] TimeOfDelete;
